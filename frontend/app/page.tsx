        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-100">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link
                href="/auth/register"
                className="block px-3 py-2 bg-gray-900 text-white rounded-lg text-center"
              >
                Get Started
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Get instant sentiment analysis on the latest news articles from multiple sources.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Beautiful charts and graphs to understand sentiment trends at a glance.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Get concise AI-generated summaries of lengthy articles and comment sections.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Multi-Source</h3>
              <p className="text-gray-600">
                Analyze news from Naver, Google, and other major news platforms.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Download your analysis results in CSV or JSON format for further processing.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Search History</h3>
              <p className="text-gray-600">
                Keep track of your searches and revisit past analysis results anytime.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gray-900 text-white rounded-2xl p-8 relative shadow-xl">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span>Up to <strong>50 articles</strong> per search</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Advanced AI analysis & summaries</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Search history & saved results</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-400 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
